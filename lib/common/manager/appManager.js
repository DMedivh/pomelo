...
var transactionLogger = require('pomelo-logger-ts').getLogger('transaction-log', __filename);
var transactionErrorLogger = require('pomelo-logger-ts').getLogger('transaction-error-log', __filename);
